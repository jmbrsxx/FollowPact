...
const PRICING_COPY = "Pay $9.99 once. Save $253.89 in year one compared to the future subscription.";
const SCOPE_LOCK_COPY = "4 Concierge Scope-Locks during Beta + Unlimited Automated Locks in V1.";
...
const faqs = [
  ...
  ["Is $9.99 a subscription?", `No. ${PRICING_COPY} This preorder does not start a subscription. After the offer ends, regular access for new customers will be $21.99 per month.`],
  ["What does founding access include?", `Private-beta access with all main features. ${SCOPE_LOCK_COPY} Full-version access at release and 55% off eligible paid features.`],
...
function FounderOfferCard() {
  return <div className="founder-offer-card">
    ...
    <p className="offer-card-price"><strong>$9.99</strong><span>{PRICING_COPY}</span></p>
    ...
    <ul className="founder-list">
      ...
      <li>{SCOPE_LOCK_COPY}</li>
      <li>55% off eligible paid features</li>
      <li>Direct access to the builder during beta</li>
    </ul>
    <CheckoutButton />
    <p className="offer-card-terms">Beta October 5 · Full version November 5 · No automatic subscription · <Link href="/terms">Terms</Link></p>
  </div>;
}
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero shell" id="top" aria-labelledby="hero-title"><div className="hero-copy"><p className="eyebrow"><span />A freelancer operating system</p><h1 id="hero-title">The Project ERP for Freelance Developers</h1><p className="hero-lead">Stop scope creep, track hours, and secure upfront approval in one dashboard.</p><OfferCountdown /><div className="hero-actions"><CheckoutButton /></div><p className="trust-line">{PRICING_COPY}</p></div></section>
